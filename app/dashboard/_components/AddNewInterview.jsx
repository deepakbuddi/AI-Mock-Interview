...
function AddNewInterview() {
    ...
    const onSubmit=async(e)=>{
        ...
        const InputPromt = "Job position: "+ jobPosition + "Job Description: " + jobDescription + "JobExpereice" + jobExperience + " , Depends on Job Position, Job Description & Years of Experience give us "+ process.env.NEXT_PUBLIC_INTERVIEW_QUESTIONS_COUNT+" Interview Questions along with Answers in JSON Format, Give us question and answer field on JSON."
                ...
                <form onSubmit={onSubmit}>
                    <div>
                        ...
                        <div className="mt-5 my-3">
                            ...
                            <Textarea placeholder="Ex. React, Angular, Vue etc" required
                        ...
                        <div className="mt-5 my-3">
                            ...
                            <Input placeholder="Ex. 3" type="number" max="70" required

...
function RecordAnswerSection({mockInterviewQuestion, activeQuestionIndex, interviewData}) {
    ...
    const UpdateUserAnswer=async() => {
        ...
        const feedbackPromt = "Question: "+mockInterviewQuestion[activeQuestionIndex]?.question + ', User Answer: ' + userAnswer+', Depends on question and user answer for give interview questions' + " please give us rating and feedback for the area to be improved if any!!" + "in jus 3 to 5 lines to imrove it in JSON format with rating field and feedback field";
